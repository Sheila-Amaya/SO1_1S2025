...
func (c *saludoServiceClient) Saludar(ctx context.Context, in *SaludoRequest, opts ...grpc.CallOption) (*SaludoResponse, error) {
	...
	err := c.cc.Invoke(ctx, SaludoService_Saludar_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedSaludoServiceServer must be embedded to have forward compatible implementations.
